...
(function (factory) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button col-xs-2'><span class='clndr-previous-button btn'><i class='fa fa-angle-left'></i></span></div><div class='month col-xs-8 text-center'><%= month %> <%= year %></div><div class='clndr-control-button col-xs-2 text-right'><span class='clndr-next-button btn'><i class='fa fa-angle-right'></i></span></div>" +
    "</div>" +
    "<table class='clndr-table table'>" +
    "<thead>" +
  ...
  Clndr.prototype.init = function () {
    ...
    $(this.element).html("<div class='clndr card'></div>");
